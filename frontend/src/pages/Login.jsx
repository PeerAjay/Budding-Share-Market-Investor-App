        ...
        <div className="row min-vh-100">
          ...
          <div className="col-lg-6 d-none d-lg-flex login-brand-side">
            ...
            <div className="brand-content">
              <div className="brand-badge mb-4">Budding Share Market Investor</div>
              ...
              <p className="brand-subtitle">
                A modern stock market simulator where players can build portfolios,
                track prices, compete on the leaderboard, and learn trading without real risk.
              </p>

              <div className="feature-list mt-4">
                <div className="feature-card">
                  <h5>Virtual Starting Balance</h5>
                  <p>Begin with $1,000,000 in simulated funds and test your strategy.</p>
                </div>

                <div className="feature-card">
                  <h5>Track Market Movement</h5>
                  <p>Monitor stock price changes and review trends through clean charts.</p>
                </div>

                <div className="feature-card">
                  <h5>Compete With Others</h5>
                  <p>Climb the leaderboard and compare your portfolio against other players.</p>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="d-flex justify-content-between align-items-center mb-4">
                  <div className="form-check">
                    <input
                      ...
                      id="rememberMe"
                    />
                    <label className="form-check-label remember-text" htmlFor="rememberMe">
                      Remember me
                    </label>
                  </div>
